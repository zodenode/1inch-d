...
function cypressProjectGenerator(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield cypressProjectGeneratorInternal(host, Object.assign({ projectNameAndRootFormat: 'derived' }, schema));
    });
}
 ...
 * @deprecated use cypressE2EConfigurationGenerator instead
 **/
function cypressProjectGeneratorInternal(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function normalizeOptions(host, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let { projectName, projectRoot } = yield (0, project_name_and_root_utils_1.determineProjectNameAndRootOptions)(host, {
            name: options.name,
            projectType: 'application',
