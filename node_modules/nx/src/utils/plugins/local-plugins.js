...
function getLocalWorkspacePlugins(projectsConfiguration, nxJson) {
    var _a, _b, _c;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const project of Object.values(projectsConfiguration.projects)) {
            ...
            if ((0, fs_1.existsSync)(packageJsonPath)) {
                ...
                const includeRuntimeCapabilities = (_a = nxJson === null || nxJson === void 0 ? void 0 : nxJson.plugins) === null || _a === void 0 ? void 0 : _a.some((p) => p.startsWith(packageJson.name));
                const capabilities = yield (0, plugin_capabilities_1.getPluginCapabilities)(workspace_root_1.workspaceRoot, packageJson.name, includeRuntimeCapabilities);
                if (capabilities &&
                    (Object.keys((_b = capabilities.executors) !== null && _b !== void 0 ? _b : {}).length ||
                        Object.keys((_c = capabilities.generators) !== null && _c !== void 0 ? _c : {}).length ||
