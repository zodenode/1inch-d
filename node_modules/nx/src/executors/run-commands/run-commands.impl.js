...
function processEnv(color, cwd) {
    const env = Object.assign(Object.assign({}, process.env), (0, npm_run_path_1.env)({ cwd: cwd !== null && cwd !== void 0 ? cwd : process.cwd() }));
    if (color) {
...
function parseArgs(options) {
    ...
    if (!args) {
        ...
        return Object.assign(Object.assign({}, unknownOptionsTreatedAsArgs), unparsedCommandArgs);
    }
